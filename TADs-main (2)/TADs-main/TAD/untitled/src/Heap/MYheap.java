...
public class MYheap<T extends Comparable<T>> implements heap_interfaz<T>{
    ...
    public MYheap ( int cap, boolean esMin) {
        size = 0;
    ...
    public MYheap ( T[] array, boolean esMin) {
        this.esMin = esMin;
        size = array.length;
